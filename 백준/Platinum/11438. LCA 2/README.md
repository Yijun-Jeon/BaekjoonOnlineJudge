# [Platinum Ⅴ] LCA 2 - 11438

[문제 링크](https://www.acmicpc.net/problem/11438) 

### 성능 요약

메모리: 14740 KB, 시간: 240 ms

### 분류

자료 구조(data_structures), 트리(tree), 최소 공통 조상(lca), 희소 배열(sparse_table)

### 문제 설명

<p>N(2 ≤ N ≤ 100,000)개의 정점으로 이루어진 트리가 주어진다. 트리의 각 정점은 1번부터 N번까지 번호가 매겨져 있으며, 루트는 1번이다.
