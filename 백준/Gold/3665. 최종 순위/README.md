...
메모리: 3232 KB, 시간: 20 ms

### 분류

그래프 이론(graph), 위상 정렬(topology_sort), 방향 비순환 그래프(directed_acyclic_graph)
...
<ul>
	...
	<li>n개의 정수 ti를 포함하고 있는 한 줄. (1 ≤ ti ≤ n) ti는 작년에 i등을 한 팀의 번호이다. 1등이 가장 성적이 높은 팀이다. 모든 ti는 서로 다르다.</li>
